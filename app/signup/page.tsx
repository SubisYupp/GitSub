...
import { Activity, Mail, ArrowLeft, Loader2, Eye, EyeOff, Check } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center px-6 py-12 relative overflow-hidden">
      ...
      >
        ...
        <p className="text-zinc-400 mb-8">Start tracking your competitive programming journey</p>
              ...
              >
                {passwordRequirements.map((req, i) => (
                  <div key={i} className="flex items-center gap-2 text-xs">
                    <div className={`w-4 h-4 rounded-full flex items-center justify-center ${req.met ? 'bg-emerald-500/20' : 'bg-zinc-800'}`}>
